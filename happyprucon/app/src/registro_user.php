                                            ...
                                            <div class="panel panel-default">
                                                <div class="panel-heading">
                                                    <h4 class="panel-title bold">
                                                        <a class="accordion-toggle" style="background-color: #<? echo $item['color'] ?>;" data-toggle="collapse" data-parent="#accordion1" href="#collapse_<?php echo $item["id"]?>" value="<?php echo $item["id"]?>"><img src="bienes/<?php echo $item["id"]?>/bien.png" width="75px" class="img-responsive"/><?php echo $item["nombre"]?></a>
                                                    </h4>
                                                </div>
