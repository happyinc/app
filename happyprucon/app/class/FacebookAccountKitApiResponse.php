...
{	
	...
	{
		//GET https://graph.accountkit.com/v1.1/access_token?grant_type=authorization_code&code=<authorization_code>&access_token=AA|<facebook_app_id>|<app_secret>
		
		// set url
		curl_setopt($this->ch, CURLOPT_URL, "https://graph.accountkit.com/v1.1/access_token?grant_type=authorization_code&code={$this->code}&access_token={$this->access_token}");
	...
	function getAccountKitAccountInfo()
	{
		...
		// set url
		curl_setopt($this->ch, CURLOPT_URL, "https://graph.accountkit.com/v1.1/me/?access_token={$this->user_access_token}&appsecret_proof={$this->appsecret_proof}");
